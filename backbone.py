...
class BackBone:
    def __init__(self, base_encoder_model='resnet50', dim=128, dense=False):
        self.model = models.__dict__[base_encoder_model](num_classes=dim)
        self.dim = self.model.fc.weight.shape[1]
...
def conv1x1(in_planes, out_planes):
    """1x1 convolution"""
    return nn.Conv2d(in_planes, out_planes, kernel_size=(1, 1), bias=False)
