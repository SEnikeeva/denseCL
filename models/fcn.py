...
class FCN(nn.Module):
    def __init__(self, num_classes=2, resnet=None):
        ...
        self.layer4[1].conv2 = nn.Conv2d(512, 512, kernel_size=(3, 3), dilation=(2, 2), stride=(1, 1), padding=(2, 2), bias=False)
        self.layer4[2].conv2 = nn.Conv2d(512, 512, kernel_size=(3, 3), dilation=(2, 2), stride=(1, 1), padding=(2, 2), bias=False)
